...
export default function SuggestionsPage() {
  ...
  const aiStatusLabel = data?.aiStatus === "live" ? "AI live" : data?.aiStatus === "fallback" ? "AI fallback" : "Mock";
  const sourceHint = data?.aiStatus === "live"
    ? "Personalized suggestion wording generated by Bedrock with deterministic savings math."
    : "Fallback suggestion wording from deterministic rules while AI generation is unavailable.";
